...
public class Insere_Empresa extends JFrame {
	...
	public Insere_Empresa() {
		...
		JLabel lblInsiraOsDados = new JLabel("CADASTRO DE EMPRESA");
		...
		lblNome.setBounds(44, 84, 70, 14);
		contentPane.add(lblNome);
		
		JLabel lblRg = new JLabel("ATUA\u00C7\u00C3O");
		lblRg.setBounds(44, 129, 57, 14);
		...
		textField.setBounds(124, 81, 472, 20);
